...
public class MoneyConverter {
    ...
    public MoneyConvertResult convertRate(MoneyConvertRequest moneyConvertRequest) {
        double convertRate = moneyConvertRequest.getAmount() * getExchangeRate(moneyConvertRequest.getToCurrency()) /
                getExchangeRate(moneyConvertRequest.getFromCurrency());
        String pattern = "##0.###";
        DecimalFormat decimalFormat = new DecimalFormat(pattern);

        String format = decimalFormat.format(convertRate);
        double resultRate = Double.parseDouble(format);
        return new MoneyConvertResult(moneyConvertRequest.getAmount(), resultRate, moneyConvertRequest.getFromCurrency(), moneyConvertRequest.getToCurrency());
    }
}
